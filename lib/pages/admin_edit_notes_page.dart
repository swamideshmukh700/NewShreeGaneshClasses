...
class AdminUpdateNotesPage extends StatefulWidget {
  final String noteId;
  final String title;
  final String content;
  final String noteClass;

  const AdminUpdateNotesPage({
    Key? key,
  ...
  @override
  _AdminUpdateNotesPageState createState() => _AdminUpdateNotesPageState();
}

class _AdminUpdateNotesPageState extends State<AdminUpdateNotesPage> {
  ...
  void initState() {
    ...
    selectedClass = widget.noteClass;
    _fetchClass();
  }
