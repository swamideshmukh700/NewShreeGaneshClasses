...
import 'package:shri_ganesh_classes/pages/admin_edit_notes_page.dart';
import 'package:shri_ganesh_classes/pages/app_drawer.dart';

class AdminListNotesPage extends StatefulWidget {
  @override
  _AdminListNotesPageState createState() => _AdminListNotesPageState();
}

class _AdminListNotesPageState extends State<AdminListNotesPage> {
  ...
  void _deleteNotes(String noteId) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
